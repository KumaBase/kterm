...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::color_themes::color_themes_load,
            commands::color_themes::color_theme_save,
            commands::color_themes::color_theme_delete,
            commands::color_themes::import_itermcolors,
